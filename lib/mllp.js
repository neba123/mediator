    ...
    var Server = net.createServer(function (sock) {
        ...
        sock.on('data', function (data) {
            ...
            if (data.indexOf(FS + CR) > -1) {
                ...
                for(value of data_array) {
                    ...
                    if(data_json == '{') {
                       // data_json += '"' + v[0].toLowerCase() + '": "' + value + '"'
                        ...
                        obx.push(value.replace("\\S\\3","/S/3"));
                    } else if (header == 'obr'){
                        obr.push(value)
                ...
                obr_json += ']'
                data_json += ', "observations" : ' + obr_json
                data_json += ', "testDetails" : ' + odx_json + ''

                data_json += '}'
                // An object of options to indicate where to post to
                console.log('ODX Json\n' + odx_json)
                console.log('OBR Json\n' + obr_json)
